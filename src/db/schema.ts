...
export const user = sqliteTable("user", {
  ...
  language: text("language", { enum: ["en", "es"] }).notNull().default("es"),
...
export const monitor = sqliteTable("monitor", {
  ...
  method: text("method", { enum: ["GET", "HEAD", "POST", "PUT", "PATCH"] }).notNull().default("GET"),
  ...
  requestBodyType: text("request_body_type", { enum: ["none", "text", "json", "form"] }).notNull().default("none"),
  followRedirects: integer("follow_redirects", { mode: "boolean" }).notNull().default(true),
  maxRedirects: integer("max_redirects").notNull().default(20),
  ...
  type: text("type", { enum: ["http", "keyword", "dns", "tcp"] }).notNull().default("http"),
  ...
  maintenanceStartsAt: integer("maintenance_starts_at", { mode: "timestamp" }),
  maintenanceEndsAt: integer("maintenance_ends_at", { mode: "timestamp" }),
