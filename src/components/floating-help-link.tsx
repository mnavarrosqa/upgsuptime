...
export function FloatingHelpLink() {
  ...
  return (
    <aside
      className="fixed bottom-[calc(var(--mobile-nav-height,0px)+1.5rem)] left-4 z-30 flex max-w-[calc(100vw-2rem)] items-end gap-3 sm:left-6 md:left-[calc(15rem+1.5rem)]"
